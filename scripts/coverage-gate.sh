...
floor_for() {
  case "$1" in
    ...
    github.com/mipmip/specgetty/src/scanner) echo "94.5" ;;
    github.com/mipmip/specgetty/src/ui)      echo "82.5" ;;
    ...
    # Measured at 85.4 in both environments. Held a fraction lower because

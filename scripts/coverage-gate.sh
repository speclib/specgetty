...
floor_for() {
  case "$1" in
    ...
    github.com/mipmip/specgetty/src/scanner) echo "94.8" ;;
    github.com/mipmip/specgetty/src/ui)      echo "83.3" ;;
    ...
    # Measured at 86.3 in both environments. Held a fraction lower because
